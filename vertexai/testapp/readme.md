# Vertex AI in Firebase Quickstart

The Vertex AI in Firebase Unity Sample demonstrates the
[Vertex AI in Firebase SDK](https://firebase.google.com/docs/vertex-ai)
with the
...
## Running the Sample inside the Editor
  ...
  - Open the scene `MainScene`.
    - Navigate to `Assets/Firebase/Sample/VertexAI` in the `Project` window.
    - Double click on the `MainScene` file to open it.
  - Import the `Vertex AI in Firebase` plugin.
    - Select the **Assets > Import Package > Custom Package** menu item.
    - From the [Firebase Unity SDK](https://firebase.google.com/download/unity)
      downloaded previously, import `FirebaseVertexAI.unitypackage`.
...
### iOS
  ...
  - Register your iOS app with Firebase.
    - Create a project in the
      ...
      - You should use `com.google.firebase.unity.vertexai.testapp` as the
  ...
  - Add the `GoogleService-Info.plist` file to the project.
    - Navigate to the `Assets/Firebase/Sample/VertexAI` folder in the `Project`
      window.
  ...
  - Optional: Update the Project Bundle Identifier
    - If you did not use `com.google.firebase.unity.vertexai.testapp`
