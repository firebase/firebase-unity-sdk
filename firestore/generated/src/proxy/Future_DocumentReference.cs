...
internal class Future_DocumentReference : FutureBase {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;

  internal Future_DocumentReference(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FirestoreCppPINVOKE.Future_DocumentReference_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(Future_DocumentReference obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  ~Future_DocumentReference() {
    Dispose();
  }
  ...
  public override void Dispose() {
    lock (FirebaseApp.disposeLock) {
      if (swigCPtr.Handle != System.IntPtr.Zero) {
        ...
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FirestoreCppPINVOKE.delete_Future_DocumentReference(swigCPtr);
        }
...
/*@SWIG@*/
  ...
  static public System.Threading.Tasks.Task<DocumentReferenceProxy> GetTask(Future_DocumentReference fu) {
    System.Threading.Tasks.TaskCompletionSource<DocumentReferenceProxy> tcs =
        new System.Threading.Tasks.TaskCompletionSource<DocumentReferenceProxy>();
...
/*@SWIG@*/
  ...
  public Future_DocumentReference() : this(FirestoreCppPINVOKE.new_Future_DocumentReference(), true) {
  ...
  internal global::System.IntPtr SWIG_OnCompletion(SWIG_CompletionDelegate cs_callback, int cs_key) {
    global::System.IntPtr ret = FirestoreCppPINVOKE.Future_DocumentReference_SWIG_OnCompletion(swigCPtr, cs_callback, cs_key);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SWIG_FreeCompletionData(global::System.IntPtr data) {
    FirestoreCppPINVOKE.Future_DocumentReference_SWIG_FreeCompletionData(swigCPtr, data);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
  }

  public DocumentReferenceProxy GetResult() {
    DocumentReferenceProxy ret = new DocumentReferenceProxy(FirestoreCppPINVOKE.Future_DocumentReference_GetResult(swigCPtr), true);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
