...
namespace Firebase.Firestore {
  ...
  internal class Future_Query : FutureBase {
    private global::System.Runtime.InteropServices.HandleRef swigCPtr;

    internal Future_Query(global::System.IntPtr cPtr, bool cMemoryOwn)
        : base(FirestoreCppPINVOKE.Future_Query_SWIGUpcast(cPtr), cMemoryOwn) {
      swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
    }

    internal static global::System.Runtime.InteropServices.HandleRef getCPtr(Future_Query obj) {
      return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(
    ...
    public override void Dispose() {
      lock (FirebaseApp.disposeLock) {
        if (swigCPtr.Handle != System.IntPtr.Zero) {
          ...
          if (swigCMemOwn) {
            swigCMemOwn = false;
            FirestoreCppPINVOKE.delete_Future_Query(swigCPtr);
          }
    ...
    static public System.Threading.Tasks.Task<QueryProxy> GetTask(Future_Query fu) {
      System.Threading.Tasks.TaskCompletionSource<QueryProxy> tcs =
          new System.Threading.Tasks.TaskCompletionSource<QueryProxy>();
      ...
      fu.SetOnCompletionCallback(() => {
        try {
          ...
          Firebase.LogUtil.LogMessage(
              ...
              System.String.Format("Internal error while completing task {0}", e));
        }
    ...
    public void SetOnCompletionCallback(Action userCompletionCallback) {
      ...
      if (SWIG_CompletionCB == null) {
        SWIG_CompletionCB = new SWIG_CompletionDelegate(SWIG_CompletionDispatcher);
      }
    ...
    public Future_Query() : this(FirestoreCppPINVOKE.new_Future_Query(), true) {
      if (FirestoreCppPINVOKE.SWIGPendingException.Pending)
        throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    }

    internal global::System.IntPtr SWIG_OnCompletion(SWIG_CompletionDelegate cs_callback,
                                                     int cs_key) {
      global::System.IntPtr ret =
          FirestoreCppPINVOKE.Future_Query_SWIG_OnCompletion(swigCPtr, cs_callback, cs_key);
      if (FirestoreCppPINVOKE.SWIGPendingException.Pending)
        throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
    ...
    public void SWIG_FreeCompletionData(global::System.IntPtr data) {
      FirestoreCppPINVOKE.Future_Query_SWIG_FreeCompletionData(swigCPtr, data);
      if (FirestoreCppPINVOKE.SWIGPendingException.Pending)
        throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    }

    public QueryProxy GetResult() {
      QueryProxy ret = new QueryProxy(FirestoreCppPINVOKE.Future_Query_GetResult(swigCPtr), true);
      if (FirestoreCppPINVOKE.SWIGPendingException.Pending)
        throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
