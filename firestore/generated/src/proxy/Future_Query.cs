...
internal class Future_Query : FutureBase {
  ...
  internal Future_Query(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FirestoreCppPINVOKE.Future_Query_SWIGUpcast(cPtr), cMemoryOwn) {
...
/*@SWIG@*/
  ...
  internal global::System.IntPtr SWIG_OnCompletion(SWIG_CompletionDelegate cs_callback, int cs_key) {
    global::System.IntPtr ret = FirestoreCppPINVOKE.Future_Query_SWIG_OnCompletion(swigCPtr, cs_callback, cs_key);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
