...
internal class Future_DocumentSnapshot : FutureBase {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;

  internal Future_DocumentSnapshot(global::System.IntPtr cPtr, bool cMemoryOwn) : base(FirestoreCppPINVOKE.Future_DocumentSnapshot_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(Future_DocumentSnapshot obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  ~Future_DocumentSnapshot() {
    Dispose();
  }
  ...
  public override void Dispose() {
    lock (FirebaseApp.disposeLock) {
      if (swigCPtr.Handle != System.IntPtr.Zero) {
        ...
        if (swigCMemOwn) {
          swigCMemOwn = false;
          FirestoreCppPINVOKE.delete_Future_DocumentSnapshot(swigCPtr);
        }
...
/*@SWIG@*/
  ...
  static public System.Threading.Tasks.Task<DocumentSnapshotProxy> GetTask(Future_DocumentSnapshot fu) {
    System.Threading.Tasks.TaskCompletionSource<DocumentSnapshotProxy> tcs =
        new System.Threading.Tasks.TaskCompletionSource<DocumentSnapshotProxy>();
...
/*@SWIG@*/
  ...
  internal global::System.IntPtr SWIG_OnCompletion(SWIG_CompletionDelegate cs_callback, int cs_key) {
    global::System.IntPtr ret = FirestoreCppPINVOKE.Future_DocumentSnapshot_SWIG_OnCompletion(swigCPtr, cs_callback, cs_key);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void SWIG_FreeCompletionData(global::System.IntPtr data) {
    FirestoreCppPINVOKE.Future_DocumentSnapshot_SWIG_FreeCompletionData(swigCPtr, data);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
  }

  public DocumentSnapshotProxy GetResult() {
    DocumentSnapshotProxy ret = new DocumentSnapshotProxy(FirestoreCppPINVOKE.Future_DocumentSnapshot_GetResult(swigCPtr), true);
    if (FirestoreCppPINVOKE.SWIGPendingException.Pending) throw FirestoreCppPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
