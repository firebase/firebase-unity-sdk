...
/// providering using the Recaptcha service. Can be used
/// for both Android and iOS platforms.
public sealed class RecaptchaProviderFactory : IAppCheckProviderFactory {
  // The static Factory singleton
  private static RecaptchaProviderFactory s_factoryInstance;

  // The C++ factory that this class wraps
  private RecaptchaProviderFactoryInternal factoryInternal;
  ...
  private RecaptchaProviderFactory(RecaptchaProviderFactoryInternal factoryInternal) {
  ...
  */
  public static RecaptchaProviderFactory Instance {
    get {
      ...
      RecaptchaProviderFactoryInternal factoryInternal = RecaptchaProviderFactoryInternal.GetInstance();
      ...
      if (factoryInternal == null) {
        throw new FirebaseException((int)AppCheckError.UnsupportedProvider,
          "Recaptcha is unavailable on this platform.");
      }
      s_factoryInstance = new RecaptchaProviderFactory(factoryInternal);
      return s_factoryInstance;
    }
  }
