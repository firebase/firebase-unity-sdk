# Contributing to the Firebase Unity SDK

We'd love for you to contribute to our source code and to make the Firebase
Unity SDK project even better than it is today! Note that we are still working
on setting up our test infrastructure, so we may choose not to accept pull
...
As contributors and maintainers of the Firebase Unity SDK project, we
...
of the Firebase Unity SDK project may take action, removing issues,
comments, and PRs or blocking accounts as deemed appropriate.

## <a name="question"></a> Got a Question or Problem?

If you have questions about how to use the Firebase Unity SDK, please
...
* Search [GitHub](https://github.com/firebase/firebase-unity-sdk/pulls) for an
...
* In GitHub, send a pull request to `firebase/firebase-unity-sdk:master`.
...
We generally follow the [.Net C# style guide][csharp-style-guide].
...
[github]: https://github.com/firebase/firebase-unity-sdk
