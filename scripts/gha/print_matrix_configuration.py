...
PARAMETERS = {
  "integration_tests": {
    "matrix": {
      ...
      EXPANDED_KEY: {
        "unity_version": ["2020.3.21f1", "2019.4.32f1", "2018.4.36f1", "2017.4.40f1", "2017.4.10f1"],
...
UNITY_PACKAGES = {
  "2020.3.21f1": {"Default": ["Unity"], "Android": ["Android"], "iOS": ["Ios"], "Windows": ["Windows-il2cpp"], "macOS": None, "Linux": ["linux-il2cpp"]},
