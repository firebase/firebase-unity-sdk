...
PARAMETERS = {
  "integration_tests": {
    "matrix": {
      ...
      EXPANDED_KEY: {
        "unity_version": ["2020.3.19f1", "2019.4.32f1", "2018.4.36f1", "2017.4.40f1"],
...
UNITY_PACKAGES = {
  ...
  "2019.4.32f1": {"Default": ["Unity"], "Android": ["Android"], "iOS": ["Ios"], "Windows": ["Windows"], "macOS": None, "Linux": ["linux-il2cpp"]},
